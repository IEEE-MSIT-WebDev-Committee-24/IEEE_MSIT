...
import "./style.css";
import IEEE_img from '../../Assets/IEEE_blue.jpg';
...
export default function LoginForm() {
    ...
    const [isVisible, setIsVisible] = useState(false);   // for password visibility

    function loginDataHandler(event){
  ...
  return (
    ...
    <div className="title_container">
        <p className="login_form_title">Login to your Account</p>
        <span className="subtitle">
        Welcome to IEEE MSIT , fill in your account details and have a great experience.
        </span>
    </div>
    <br />
  ...
  <div className="input_container">
    ...
    <input
      ...
      id="password_field"
    />
    <IoEyeOutline className='see-password' onClick={() => {setIsVisible(!isVisible);}}/>
  </div>
